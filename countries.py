...
# ISO Alpha-2 country codes, alternative names included
country_map = {
    ...
    "brunei": "BN", "bulgaria": "BG", "burkina faso": "BF", "burundi": "BI", "côte d’ivoire": "CI", "ivory coast": "CI",
    "cabo verde": "CV", "cambodia": "KH", "cameroon": "CM", "canada": "CA", "central african republic": "CF", "chad": "TD",
    "chile": "CL", "china": "CN", "colombia": "CO", "comoros": "KM", "congo": "CG", "congo (democratic republic)": "CD",
    ...
    "el salvador": "SV", "equatorial guinea": "GQ", "eritrea": "ER", "estonia": "EE", "eswatini": "SZ", "swaziland": "SZ",
    ...
    "monaco": "MC", "mongolia": "MN", "montenegro": "ME", "morocco": "MA", "mozambique": "MZ", "myanmar": "MM", "burma": "MM",
    ...
    "philippines": "PH", "poland": "PL", "portugal": "PT", "qatar": "QA", "romania": "RO", "russia": "RU", "russian federation": "RU",
    ...
    "uae": "AE", "united kingdom": "GB", "uk": "GB", "great britain": "GB", "united states": "US", "usa": "US", "us": "US",
